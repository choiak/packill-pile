	...
	<div class="flex space-x-4">
		...
		<div class="flex w-[300px] flex-col space-y-4">
			...
			<div class="rounded-xl border bg-orange-50">
				<div
					class="flex items-center justify-between rounded-t-xl border-b px-4 py-2 text-orange-600 bg-stripes bg-stripes-orange-100"
				>
				...
				<div class="p-4">
					<router-link class="space-y-2" to="/delete-account">
						<p class="text-xs font-medium text-neutral-500">
							...
							<strong class="uppercase">no going back</strong>
							. Please be
							<strong class="uppercase">certain</strong>
							.
						</p>
