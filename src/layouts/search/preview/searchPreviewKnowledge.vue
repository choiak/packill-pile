<template>
	<div class='space-y-8'>
		...
		<div class='px-4 py-2 border rounded-lg bg-neutral-100 w-full space-y-4'>
			<div class='rounded border px-1 text-xs font-medium text-white bg-orange-600 border-orange-600 w-fit'
				 v-if='type'>
				<p>{{ type }}</p>
			</div>
			<div class='space-y-1'>
			...
			<div class='space-y-1'>
				<div class='flex items-center justify-between'>
					<p class='uppercase text-xs text-neutral-500 font-bold'>This knowledge is about</p>
		...
		<div class='space-y-2'>
			<div class='flex items-center justify-between'>
				<p class='uppercase text-sm text-neutral-500 font-bold'>Content</p>
			</div>
			<div
				v-html='content'
