				...
				<div class='flex justify-between items-center'>
					<div class='flex items-baseline space-x-4'>
						<router-link
							...
							:class="{
							'text-2xl font-bold': path === '/settings/general',
						...
						<router-link
							...
							class='relative before:absolute before:-bottom-2 before:left-1/2 before:h-1 before:w-4 before:-translate-x-1/2 before:rounded-full before:bg-blue-600'
							:class="{
							'text-2xl font-bold': path === '/settings/security',
						...
						<router-link
							...
							class='relative before:absolute before:-bottom-2 before:left-1/2 before:h-1 before:w-4 before:-translate-x-1/2 before:rounded-full before:bg-blue-600'
							:class="{
							'text-2xl font-bold': path === '/settings/subscription',
							'before:hidden': path !== '/settings/subscription',
						}"
						>
							Subscription
						</router-link>
					...
					<SettingsValidationPrompt @unlocked-state='getUnlockedState' :modified='modified' />
				</div>
